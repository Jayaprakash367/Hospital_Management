...
class NewAppointmentDialog:
    ...
    def save_appointment(self):
        ...
        try:
            ...
            # Check for conflicts considering duration overlap
            conflict_query = '''
            ...
            if conflicts:
                messagebox.showerror("Conflict", "This time slot overlaps with an existing appointment for the selected doctor.")
                return
            ...
            # Show doctor details confirmation
            doctor_name = self.doctor_var.get()
            doctor_specialization = ""
            # Extract specialization from doctor string "Dr. First Last (Specialization)"
            if '(' in doctor_name and ')' in doctor_name:
                doctor_specialization = doctor_name.split('(')[-1].strip(')')
            messagebox.showinfo(
                "Appointment Scheduled",
                f"Appointment scheduled with {doctor_name}.\nSpecialization: {doctor_specialization}"
            )
