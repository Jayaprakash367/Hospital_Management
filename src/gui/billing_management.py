...
class BillingManagement:
    ...
    def load_bills(self):
        ...
        try:
            ...
            messagebox.showerror("Error", "Unable to load billing records. Please check your database connection and try again.")
    ...
    def show_reports(self):
        ...
        try:
            reports_win = tk.Toplevel(self.parent)
            reports_win.title("Reports & Analytics Dashboard")
            reports_win.geometry("1100x700")
            reports_win.transient(self.parent)
            reports_win.grab_set()
            ReportsDashboard(reports_win, self.db_manager)
        except Exception as e:
            messagebox.showerror("Error", f"Could not open reports module: {e}")
...
class CreateBillDialog:
    ...
    def load_patients(self):
        ...
        try:
            ...
            messagebox.showerror("Error", "Unable to load patient list. Please check your database connection and try again.")
    ...
    def save_bill(self):
        ...
        try:
            ...
            messagebox.showerror("Error", "Unable to create the bill. Please verify all information is correct and try again.")
...
class RecordPaymentDialog:
    ...
    def load_bill_details(self):
        ...
        try:
            ...
            messagebox.showerror("Error", "Unable to load bill details. Please check your database connection and try again.")
            self.dialog.destroy()
    ...
    def save_payment(self):
        ...
        try:
            ...
            messagebox.showerror("Error", "Unable to record the payment. Please verify the payment details and try again.")
